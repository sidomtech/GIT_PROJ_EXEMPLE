...
new string[] { DB_PHOTO_BASE64_COLNAME, "TEXT", "", "NOT NULL" } } } };
        ...
        internal GestionnaireBDD(string databasePath)
        {
            ...
            try
            {
                this._databasePath = (databasePath == "") ? System.IO.Path.Combine(System.Environment.CurrentDirectory, Const.DEFAULT_DB_FILENAME) : databasePath;
            }
            catch (Exception ex)
            {
