...
{
    internal delegate TResult Operation<TResult, TParam1, TParam2>
        (
            SQL.GestionnaireBDD bdd,
            Log log,
            TParam1 parametre,
            params TParam2[] autresParametres
        )
        where TResult : DataContracts.ResultatOperation;
    ...
    class GestionnaireOperation
    {
        ...
        /// <param name="ajouterLogFichier"></param>
        /// <param name="ajouterLogWindows"></param>
        ...
        internal static bool LireParametreURIEntier(
            string nomParametre, 
            out int valeurParametre)
        {
            valeurParametre = 0;
            string strValue;
        ...
        internal static bool LireParametreURI<T>(
            string nomParametre, 
            out T valeurParametre
            )
        {
        ...
        private static bool LireParametreURI(
            string nomParametre, 
            out string valeurParametre)
        {
            valeurParametre = "";
